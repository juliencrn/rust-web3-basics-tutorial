...
async fn main() -> web3::Result<()> {
    ...
    // Prepare "swapExactETHForTokens" params
    ...
    let transaction_object = TransactionParameters {
        nonce: Some(nonce),
        to: Some(router_addr),
